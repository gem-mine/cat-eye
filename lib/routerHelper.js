...
function parseRedirect(route) {
  ...
  if (!route.sub && to) {
    to = (typeof to === 'undefined' ? 'undefined' : _typeof(to)) === 'object' ? urlFor(to.key, to.params) : _routers[to].path;
    if (route.path !== to) {
...
var Routes = exports.Routes = function Routes(props) {
  ...
  var rs = void 0;
  var mapStateToProps = props.mapStateToProps;
  if (!mapStateToProps) {
